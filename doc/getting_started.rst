...
For integration with a real MCU, the ``zenbedded_hardware_interface``
must be instantiated in a ``ros2_control`` URDF with the required
parameters. See the :ref:`zenbedded_hardware_interface_userdoc` for
parameter details.
